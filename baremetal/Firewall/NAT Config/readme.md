...
(※ ex. WAN0/0/0 에서 설정)
![f1](https://github.com/QubitSecurity/documentation/blob/main/Physical_Server/IBMC_Config/images/bmc1.png](https://github.com/QubitSecurity/howto/blob/main/baremetal/Firewall/NAT%20Config/images/f1.png)
