...
```bash
git clone git@gitlab.plura.internal:config/Intelligence.git
cd Intelligence
```
...
```bash
git clone git@d-gitlab:config/Intelligence.git
cd Intelligence
```
...
```bash
git clone git@s-gitops:config/Intelligence.git s-Intelligence
cd s-Intelligence
```
...
```bash
git remote add dev git@d-gitlab:config/Intelligence.git
git fetch dev main
```
...
```bash
git remote add live git@gitops:config/Intelligence.git
git fetch live
```
