...
2  Proxy1 은
   1) xff 를 생성, Haproxy 접속
   2) Proxy2 접속 경유 자신 XFF 추가 생성, haproxy 접속
...
curl-1 (curl -k -x "http://proxy" -H "X-Forwarded-For: 1.1.1.1"  http://domain/)
192.168.10.35 - - [01/Jul/2026:10:17:18 +0900] "GET /a HTTP/1.1" 404 3332 "-" "curl/8.19.0" "172.16.10.200,172.16.18.253"
curl-2 (curl -k -x "http://proxy" -H "X-Forwarded-For: 1.1.1.1.,2.2.2.2" http://domain/)
192.168.10.35 - - [01/Jul/2026:10:18:26 +0900] "GET /a HTTP/1.1" 404 3332 "-" "curl/8.19.0" "172.16.10.200,172.16.18.253"
curl-3 (curl -k -x "http://proxy" -H "X-Forwarded-For: 1.1.1.1" -H "X-Forwarded-For: 3.3.3.3"  http://domain)
...
client가 아래 패턴와  curl-3 형식 실행 시, 임의 지정된 xff 정보를 로그에 생성하지 못함.
